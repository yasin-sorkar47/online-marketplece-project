...
const MyPostedJobs = () => {
  ...
  const deleteJob = (id) => {
    try {
      axios.delete(`${import.meta.env.VITE_BASE_URL}/job/${id}`);
      getAllDataFromDB();
    } catch (error) {
  ...
  const handleDelete = (id) => {
    toast((t) => (
      <div className="flex gap-x-4">
        <span>
          Are Sure To <b>Delete</b>
        </span>
        <div className="space-x-2">
          <button
            className="px-4 bg-red-500 py-1 rounded-md text-white"
            onClick={() => {
              toast.dismiss(t.id);
              deleteJob(id);
            }}
          ...
          <button
            className="px-4 bg-green-500 py-1 rounded-md text-white"
                ...
                <tbody className="bg-white divide-y divide-gray-200 ">
                  {jobs.map((job) => (
                    <tr key={job._id}>
                      ...
                      <td className="px-4 py-4 text-sm text-gray-500  whitespace-nowrap">
                        {job.description.substring(1, 18)}...
                      </td>
                      <td className="px-4 py-4 text-sm whitespace-nowrap">
